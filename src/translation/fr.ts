const fr = {
  ...
  reactivateAccount: {
    ...
    description: "Votre compte a été archivé en raison d'inactivité (aucune connexion depuis plus d'un an). Pour le réactiver, veuillez définir un nouveau mot de passe et confirmer vos informations.",
    emailLabel: "E-mail",
    ...
    loadingData: "Chargement de vos informations...",
    ...
    errors: {
      ...
      failedToLoadData: "Échec du chargement des données de votre compte. Veuillez réessayer.",
    },
  },

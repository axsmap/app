const fr = {
  ...
  reactivateAccount: {
    ...
    showEmail: "Afficher mon e-mail sur mon profil",
    showPhone: "Afficher mon numéro de téléphone sur mon profil",
    showDisabilities: "Afficher mes handicaps sur mon profil",
    ...
    errors: {
      ...
      userIdMissing: "L'ID utilisateur est manquant",
      invalidRequest: "Demande invalide",
      invalidRequestDescription: "Le lien de réactivation est invalide ou a expiré. Veuillez contacter le support pour obtenir de l'aide.",

const fr = {
  ...
  mapathonsMyDrafts: "Mes brouillons",
  mapathonDraftBadge: "Brouillon",
  mapathonActionsTitle: "Actions du Mapathon",
  mapathonPublishButton: "Publier le Mapathon",
  mapathonPublishing: "Publication...",
  mapathonPublishSuccess: "Mapathon publié avec succès !",
  mapathonPublishError: "Échec de la publication du mapathon. Veuillez réessayer.",
  mapathonDeleteButton: "Supprimer le Mapathon",
  mapathonDeleting: "Suppression...",
  mapathonDeleteSuccess: "Mapathon supprimé avec succès !",
  mapathonDeleteError: "Échec de la suppression du mapathon. Veuillez réessayer.",
  mapathonDeleteConfirmTitle: "Êtes-vous sûr ?",
  mapathonDeleteConfirmMessage: "Cette action est irréversible. Le mapathon et toutes ses données seront définitivement supprimés.",
  mapathonDeleteConfirmButton: "Oui, supprimer",
  mapathonDeleteCancelButton: "Annuler",
  mapathonDeleteDisabledTooltip: "Ce Mapathon ne peut pas être supprimé car des participants y ont déjà participé.",
  mapathonDeleteDisabledShort: "A des participants",
  mapathonSaveAsDraft: "Enregistrer comme brouillon",
  mapathonCreateAndPublish: "Créer et publier",
  ...
  createMapathonDraftSuccess: "Mapathon enregistré comme brouillon avec succès",
  createMapathonSaveDraft: "Enregistrer comme brouillon",
  createMapathonPublishButton: "Créer et publier",
  ...
  teamAlreadyMember: "Membre de l'équipe",

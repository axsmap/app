const en = {
  ...
  reactivateAccount: {
    ...
    description: "Your account has been archived due to inactivity. Please set a new password and update your information to reactivate your account.",
    setNewPassword: "Set New Password",
    password: "New Password",
    passwordPlaceholder: "Enter your new password",
    confirmPassword: "Confirm Password",
    confirmPasswordPlaceholder: "Re-enter your password",
    passwordResetInfo: "Step 1: Set a new password to secure your account.",
    personalInfo: "Personal Information",
    personalInfoNote: "Step 2: Review and update your personal information.",
    finalStepNote: "Step 3: Add optional details and complete reactivation.",
    ...
    showEmail: "Show my email on my profile",
    showPhone: "Show my phone number on my profile",
    showDisabilities: "Show my disabilities on my profile",
    reactivateButton: "Reactivate Account",
    reactivating: "Reactivating...",
    returnHome: "Return to Home",
    loadingData: "Loading your information...",
    successMessage: "Account successfully reactivated! Welcome back.",
    errors: {
      ...
      invalidRequestDescription: "The reactivation link is invalid or has expired. Please contact support for assistance.",
      generalError: "An error occurred. Please try again.",
      failedToLoadData: "Failed to load your account data. Please try again.",
    },
  },

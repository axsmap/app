const en = {
  ...
  voiceReview: {
    ...
    recordingInstructions: "Describe the accessibility features like entrance, ramps, elevator, bathroom, and any specific details for the comment section.",
    processingTitle: "Processing...",
    processingDescription: "We're transcribing your recording and extracting accessibility information.",
    instructions: "Tap the button and describe the accessibility of this location. Mention entrance, ramps, steps, bathroom, and elevator. Please mention more specific details in the comment section.",
  ...
  shareMapathonButton: "Share Mapathon",
  shareMapathonTitle: "Share Mapathon",
  shareMapathonDescription: "Share this Mapathon by text, social, link, or email.",
  shareMapathonCloseLabel: "Close share options",
  shareMapathonInviteText:
    "Join me in the {{name}} Mapathon to help make {{address}} more accessible through AXS Map! Every accessibility review helps people living with disabilities find accessible businesses and public spaces.",
  shareMapathonEmailSubject: "Join me in the {{name}} Mapathon",
  shareMapathonTextInvite: "Text Message Invite",
  shareMapathonCopyLink: "Copy Link",
  shareMapathonEmailTemplate: "Email Template",
  shareMapathonEmailTemplateLabel: "Email template",
  shareMapathonCopyEmailTemplate: "Copy Email Template",
  shareMapathonCopied: "Copied!",
  shareMapathonCopyToast: "Copied!",
  shareMapathonCopyErrorToast: "Could not copy. Please try again.",
  shareMapathonOpeningMessages: "Opening Messages...",
  shareMapathonFacebookCopiedToast: "Invite copied. Paste it into your Facebook post.",
  shareMapathonFacebookFallbackToast: "Facebook may not prefill the message. Copy the invite text if needed.",
  ...
  DonorAboutTitle: "Get To Know The Founder Jason DaSilva",

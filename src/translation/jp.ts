const jp = {
  ...
  cookiesTableRows: [
    ...
    },
    {
      ...
      managingSettings: {
        browserText: "ブラウザの設定でパフォーマンスクッキーを無効にする方法については、",
        browserLinkText: "こちらをクリックしてください",
        flashText: "Flashクッキーのプライバシーとストレージ設定を管理する方法については、",
        flashLinkText: "こちらをクリックしてください",
      },
    },
    {
      type: "機能性クッキー",
      ...
      managingSettings: {
        browserText: "ブラウザの設定で機能性クッキーを無効にする方法については、",
        browserLinkText: "こちらをクリックしてください",
        flashText: "Flashクッキーのプライバシーとストレージ設定を管理する方法については、",
        flashLinkText: "こちらをクリックしてください",
      },

...
export function getReviewsRatioWeight(reviewData) {
  ...
  if (reviewData.entryScore) {
    ...
    if (entryScore >= 1 && entryScore < 4) reviewsActualWeight += 0.5
    else if (entryScore >= 4 && entryScore < 6) reviewsActualWeight += 1.5
    else if (entryScore >= 6) reviewsActualWeight += 3
  }

  if (reviewData.interiorScore) {
    reviewsTotalWeight += 3

    const interiorScore = reviewData.interiorScore
    if (interiorScore  >= 1 && interiorScore  < 4) reviewsActualWeight += 0.5
    else if (interiorScore >= 4 && interiorScore < 6) reviewsActualWeight += 1.5
    else if (interiorScore  >= 6) reviewsActualWeight += 3
  }
  // if (
  ...
  if (reviewData.bathroomScore) {
    ...
    if (bathroomScore >= 1) reviewsActualWeight += 0.5
    else if (bathroomScore >= 2) reviewsActualWeight += 1.5
    else if (bathroomScore >= 3) reviewsActualWeight += 3
  }

...
const EditPetition = (props, context) => {
  ...
  switch (props.type) {
    ...
    case 'request-user-event':
      ...
      avatarTo = `/mapathons/${props.event.id}`
      templateValues.event = (
        <LinkToProfile to={`/mapathons/${props.event.id}`}>
          {props.event.name}
        </LinkToProfile>
      )
      break

    case 'invite-team-event':
    case 'request-team-event':
      avatar = props.event.poster
      avatarTo = `/mapathons/${props.event.id}`
      templateValues.event = (
        <LinkToProfile to={`/mapathons/${props.event.id}`}>
